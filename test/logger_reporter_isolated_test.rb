...
class LoggerReporterIsolatedTest < Test::Unit::TestCase
  ...
  def test_specify_registry
    ...
    reporter = Metriks::Reporter::Logger.new(:registry => registry)
    reporter.write
  end
  ...
  def test_uses_default_registry
    ...
    Metriks::Reporter::Logger.new.write
  end
  ...
  def test_specify_interval
    ...
    Metriks::Reporter::Logger.new(:interval => 42)
  end
  ...
  def test_specify_error_handler
    ...
    reporter = Metriks::Reporter::Logger.new(:on_error => handler)
